      ...
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[540px] aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-xl">
            ...
            {/* Gornji plutajući bedž (Trusted by Clients) */}
          ...
          {/* Donja desna plutajuća kartica 1 (850+ Properties Sold) */}
          <div className="absolute -bottom-4 right-12 md:right-20 bg-white rounded-2xl p-4 flex items-center gap-4 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.12)] border border-slate-50 w-52 transform translate-y-[-80px]">
          ...
          {/* Donja desna plutajuća kartica 2 (15 Years Experience) */}
