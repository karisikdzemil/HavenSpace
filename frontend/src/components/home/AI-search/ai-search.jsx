    ...
    <section className="bg-[#FBFCFC]">
      <ContentWrapper>
        <div className="max-w-5xl mx-auto">
          ...
          <Reveal direction="scale" delay={0.1} className="bg-white rounded-[2.5rem] border border-slate-100 shadow p-6">
          ...
          {aiMessage && (
            <Reveal className="mt-10 p-6 rounded-3xl bg-[#f0f7f7] border border-[#dceaea]">
          ...
          {aiProperties.length > 0 && (
            <RevealGroup className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8" staggerDelay={0.1}>
              {aiProperties.map((property) => (
                <RevealItem key={property._id} direction="scale">
