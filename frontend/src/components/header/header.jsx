...
export default function Header() {
  ...
  <div className="w-full bg-white rounded-[50px] shadow-xl py-[5px] px-[25px] flex items-center justify-between">
    
    <h1 className="text-[22px] font-bold text-[#163535]">
      HavenSpace
    </h1>
    ...
    <button className="block xl:hidden cursor-pointer">
      <FontAwesomeIcon className="text-xl transition-all hover:text-[#3d9ea0]" icon={faBars} />
    </button>
